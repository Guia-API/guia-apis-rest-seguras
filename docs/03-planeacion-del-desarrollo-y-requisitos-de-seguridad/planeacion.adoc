...
Es importante señalar que no todas las prácticas propuestas en esta sección serán necesariamente aplicables en todos los contextos de desarrollo. Por ejemplo, el análisis del inventario de APIs existentes puede no ser pertinente en organizaciones que no cuenten previamente con un ecosistema de APIs. En estos casos, dicha práctica puede omitirse o adaptarse según el contexto particular del proyecto, sin que ello comprometa la validez del proceso de planeación.

Antes de continuar con la fase de elicitación y definición detallada de requisitos, se recomienda que el diseñador de la API reflexione y dé respuesta, al menos de manera preliminar, a las siguientes preguntas de verificación:

* ¿A quién va dirigida la API y quiénes serán sus principales consumidores?
* ¿Cuál es el contexto organizacional y operativo en el que se desplegará la API?
* ¿Qué problema específico se busca resolver mediante la API?
* ¿Qué tipo de datos manejará la API y qué tan sensibles son?
* ¿Existen restricciones normativas o regulatorias que deban considerarse desde el diseño?
* ¿Qué expectativas de seguridad existen por parte de la organización o de los usuarios finales?

=== Estructura de Desglose del Trabajo (EDT)

La Estructura de Desglose del Trabajo (EDT), o Work Breakdown Structure (WBS), es una técnica de planificación utilizada para descomponer de manera jerárquica el alcance total de un proyecto en componentes más pequeños y manejables. De acuerdo con el Project Management Body of Knowledge (PMBOK® Guide – Seventh Edition), la EDT se define como una descomposición jerárquica del trabajo total que debe realizar el equipo del proyecto para cumplir con los objetivos y generar los entregables requeridos (Project Management Institute, 2021).

El propósito fundamental de la EDT es servir como una herramienta de organización que permita transformar un proyecto complejo en un conjunto estructurado de tareas y entregables, facilitando su planificación, asignación de responsabilidades, seguimiento y control. Al dividir el trabajo en partes más pequeñas, la EDT contribuye a reducir la complejidad, evitar omisiones y mejorar la comprensión global del proyecto (Phillips, s.f.).

Un principio esencial de la EDT es la denominada regla del 100%, la cual establece que la suma de los elementos descompuestos debe representar el 100% del alcance del proyecto, sin duplicidades ni elementos faltantes (Project Management Institute, 2019). Esto garantiza que todo el trabajo necesario esté contemplado dentro de la estructura, evitando tanto la sobrecarga como las lagunas en la planificación.

Entre los principales beneficios del uso de una EDT se encuentran: la división del trabajo en componentes manejables, la alineación de las tareas con los entregables del proyecto, la mejora en la estimación de tiempos, costos y recursos, así como la prevención de que actividades relevantes queden fuera del alcance del proyecto (Mulcahy, 2018). Asimismo, la EDT fortalece la trazabilidad entre actividades, requisitos y productos finales, lo cual resulta especialmente relevante en proyectos de software.

La EDT puede adoptar distintos enfoques de descomposición, tales como orientada a productos, fases, entregables o actividades, e incluso combinaciones híbridas, dependiendo de la naturaleza del proyecto (Project Management Institute, 2019; Haugan, 2002). En proyectos de desarrollo de software y APIs web, resulta especialmente útil una EDT orientada a entregables y fases, ya que permite organizar el trabajo desde la definición de requisitos hasta el despliegue y mantenimiento del sistema.

En el contexto del diseño de APIs REST seguras, la EDT cobra especial relevancia al permitir integrar de manera explícita las actividades relacionadas con la seguridad desde las primeras etapas del proyecto, asegurando que no se traten como aspectos aislados o posteriores al desarrollo funcional.


==== Ejemplo de EDT para una API REST segura

La siguiente estructura ilustra una posible EDT genérica que puede adaptarse a distintos contextos de desarrollo de APIs REST seguras:

[source]

Planeación del proyecto de API REST
1.1 Definición de alcance y objetivos
1.2 Identificación de actores y partes interesadas
1.3 Análisis del contexto organizacional
Ingeniería de requisitos
2.1 Elicitación de requisitos funcionales
2.2 Elicitación de requisitos de seguridad
2.3 Priorización y validación de requisitos
2.4 Elaboración de la ERS
2.5 Trazabilidad de requisitos
Diseño de la API
3.1 Definición de arquitectura
3.2 Modelado de recursos REST
3.3 Definición de contratos (endpoints, métodos, formatos)
3.4 Diseño de mecanismos de autenticación y autorización
3.5 Modelado de amenazas
3.6 Diseño de controles de seguridad
Implementación
4.1 Desarrollo de endpoints
4.2 Implementación de validación de entradas
4.3 Implementación de control de acceso
4.4 Implementación de manejo de errores
4.5 Implementación de mecanismos criptográficos y tokens
4.6 Configuración de rate limiting
Pruebas y verificación
5.1 Pruebas funcionales
5.2 Pruebas de seguridad básicas
5.3 Validación contra requisitos
5.4 Documentación de resultados
Despliegue y operación
6.1 Configuración de entornos
6.2 Despliegue seguro
6.3 Configuración de monitoreo y registros
6.4 Gestión de versiones y actualizaciones
Documentación y mantenimiento
7.1 Documentación técnica de la API
7.2 Manuales de uso y consumo
7.3 Actualización de artefactos de diseño
7.4 Gestión de cambios

A continuación, se presenta una EDT en formato gráfico correspondiente a la fase de implementación, en la cual se ha descompuesto la API del ejemplo en distintos módulos funcionales. Esta descomposición permite estructurar el desarrollo del sistema de manera organizada, facilitando la planificación del orden de implementación, así como la asignación y distribución de tareas entre los integrantes del equipo. De este modo, la EDT no solo apoya la gestión del proyecto, sino que también contribuye a una construcción progresiva y controlada de la API REST.

image::edt-grafico.png[Estructura de Desglose del Trabajo (EDT) para la fase de implementación de una API REST segura]
...
Antes de elaborar una Especificación de Requisitos de Software (SRS), es recomendable definir claramente la visión del producto y el alcance del proyecto, ya que ambos constituyen elementos fundamentales de los requisitos de negocio.

De acuerdo con Wiegers, la visión del producto describe de manera concisa el producto final que permitirá alcanzar los objetivos del negocio. Esta visión no solo indica qué es el producto, sino también en qué puede llegar a convertirse, proporcionando un marco de referencia para la toma de decisiones a lo largo de su ciclo de vida y alineando a todos los interesados en una misma dirección [23].

Por su parte, el alcance del proyecto delimita qué parte de esa visión será abordada por el proyecto o por una iteración específica de desarrollo. En otras palabras, establece explícitamente qué está dentro y qué queda fuera del proyecto actual, evitando ambigüedades y expectativas irreales [23].

Wiegers señala que tanto la visión como el alcance suelen integrarse en un documento de visión y alcance, el cual reúne los requisitos de negocio en un único entregable que sirve como base para el trabajo de desarrollo posterior. Este documento suele ser responsabilidad del patrocinador del proyecto o de la autoridad financiadora, y puede ser elaborado con apoyo de un analista de negocios, a partir de la información proporcionada por actores clave como gerentes, expertos del dominio o responsables de producto [23].

A diferencia del SRS, el documento de visión y alcance define el alcance a un nivel alto de abstracción. Los detalles funcionales y técnicos se refinan posteriormente en la especificación de requisitos. En proyectos grandes se recomienda contar tanto con un documento completo de visión y alcance como con un SRS, mientras que en proyectos evolutivos o iterativos el alcance puede definirse directamente dentro de la documentación de requisitos de cada versión [23].

De este modo, el documento de visión y alcance complementa al SRS, ya que asegura que los requisitos detallados se desarrollen dentro de un marco estratégico claro y compartido, reduciendo riesgos de desviaciones y reprocesos.

Como parte del estudio de caso desarrollado en este trabajo, se elaboró un documento de visión y alcance aplicado al sistema clínico. Dicho documento se pone a disposición como ejemplo práctico para el lector y puede consultarse en el siguiente enlace:
https://github.com/Guia-API/HealREST-docs/blob/main/Vision-Alcance_Guia-APIs-REST.pdf
...
Como parte del estudio de caso desarrollado en este trabajo, se elaboró una Especificación de Requisitos de Software (ERS) correspondiente al sistema clínico utilizado como caso de estudio. Este documento se pone a disposición como ejemplo práctico para el lector, con el objetivo de ilustrar la aplicación de los principios descritos en esta sección, y puede consultarse en el siguiente enlace:
https://github.com/Guia-API/HealREST-docs/blob/main/ERS_Gu%C3%ADa-API-REST.pdf
...
A continuación, se presenta un ejemplo simplificado de una matriz de trazabilidad de requisitos:

image::matriz-trazabilidad-req-ejemplo.png[Ejemplo de matriz de trazabilidad de requisitos]
...
En la siguiente sección se describen metodologías específicas para el modelado de amenazas, las cuales facilitan la identificación y análisis sistemático de riesgos en el contexto del desarrollo de APIs REST seguras.
...
Para facilitar la aplicación del modelo STRIDE en el proceso de identificación de amenazas, a continuación se presenta una tabla que resume cada una de sus categorías, su descripción, la propiedad de seguridad asociada y su propósito dentro del diseño seguro. Esta tabla puede utilizarse como referencia durante el análisis, permitiendo al diseñador evaluar de manera sistemática los posibles riesgos que afectan a cada componente.


[cols="1,2,1,2", options="header"]
|===
|Tipo de amenaza (STRIDE) |Descripción |Propiedad de seguridad |Explicación

|Spoofing
|Acción maliciosa orientada a suplantar la identidad de un usuario o sistema, por ejemplo mediante el uso indebido de credenciales.
|Autenticación
|La autenticación adecuada permite verificar la identidad de los actores y prevenir accesos no legítimos.

|Tampering
|Modificación maliciosa de datos persistentes o en tránsito, incluyendo creación, alteración o eliminación no autorizada de información.
|Integridad
|La integridad garantiza que los datos no sean alterados de forma no autorizada y se mantengan correctos y confiables.

|Repudiation
|Realización de acciones sin posibilidad de ser rastreadas o verificadas posteriormente por falta de registros adecuados.
|No repudio
|El no repudio permite demostrar que una acción fue realizada por un actor específico, evitando que niegue su responsabilidad.

|Information Disclosure
|Acceso o exposición no autorizada de información confidencial, ya sea almacenada o en tránsito.
|Confidencialidad
|La confidencialidad asegura que solo los actores autorizados puedan acceder a información sensible.

|Denial of Service (DoS)
|Intento de degradar o impedir la disponibilidad de un servicio mediante sobrecarga o bloqueo de recursos.
|Disponibilidad
|La disponibilidad garantiza que los servicios estén accesibles y operativos cuando los usuarios legítimos los requieren.

|Elevation of Privilege
|Obtención de permisos superiores a los autorizados, permitiendo ejecutar acciones no previstas.
|Autorización
|La autorización controla los privilegios de acceso de los actores según su rol o nivel de permisos.
|===
...
[cols="2,2,2,2,4,1", options="header"]
|===
|Elemento del DFD |Riesgo |Categoría STRIDE |Amenaza |Descripción |Prioridad
...
|Elevation of Privilege
|Uso indebido de tokens
|Una gestión insegura de tokens podría permitir reutilizar o manipular tokens para acceder a funciones no autorizadas.
|Alta
...
|Tampering
|Manipulación de información de pacientes
|Un usuario con permisos insuficientes podría modificar o eliminar registros de pacientes explotando fallas de validación.
|Alta
...
|Information Disclosure
|Exposición de historiales clínicos
|Fallas en el control de acceso podrían permitir consultar información médica sensible sin autorización.
|Alta
...
|Repudiation
|Negación de modificaciones
|Un usuario podría negar haber modificado información clínica si no existen mecanismos de auditoría adecuados.
|Media
...
|Tampering
|Manipulación de consultas médicas
|Un atacante podría modificar o eliminar consultas sin autorización, afectando la integridad clínica.
|Alta
...
|Tampering
|Manipulación de citas
|Un atacante podría modificar fechas, estados o médicos asignados a citas médicas.
|Media
...
|Elevation of Privilege
|Escalada de privilegios
|Un usuario podría obtener privilegios administrativos por validaciones incorrectas de rol.
|Alta

|Flujo de datos HTTP(S)
|Intercepción de información
|Information Disclosure
|Exposición de datos en tránsito
|Las solicitudes y respuestas podrían ser interceptadas si no se usa cifrado TLS adecuado.
|Alta

|Base de Datos Clínica (Data Store)
|Acceso no autorizado a la información
|Elevation of Privilege
|Ejecución de SQL no autorizado
|Un atacante podría ejecutar consultas con privilegios elevados sobre la base de datos.
|Alta
...
|Tampering
|Manipulación de datos en frontera de confianza
|Payloads maliciosos podrían cruzar la frontera de confianza si no se validan adecuadamente.
|Alta
|===
...
[cols="2,2,2,2,4,1", options="header"]
|===
|Elemento |Riesgo |Categoría |Amenaza |Mitigaciones |Prioridad

|Heal REST API (Proceso)
|Indisponibilidad del servicio
|Denial of Service
|Saturación del API
|Se implementa rate limiting a nivel sistema mediante Nginx como proxy inverso, limitando el número de peticiones por intervalo de tiempo. Se monitorea el tráfico para detectar comportamientos anómalos. +
Parcial: existe rate limiting en Nginx, pero no hay protección DDoS avanzada.
|Alta
...
|Spoofing
|Suplantación de identidad
|Se emplea hasheo de contraseñas. Se aplican políticas de contraseñas (8–15 caracteres, letras, números y símbolos). La autenticación se realiza mediante tokens. +
Parcial: hay hashing y tokens, pero no MFA ni bloqueo por intentos fallidos.
|Alta
...
|Elevation of Privilege
|Uso indebido de tokens
|Se utiliza autenticación basada en tokens. Los tokens se validan en cada solicitud protegida y se transmiten únicamente sobre HTTPS. +
Parcial: se validan tokens y se usa HTTPS, pero sin rotación ni revocación avanzada.
|Alta
...
|Tampering
|Manipulación de información de pacientes
|Se valida el acceso mediante roles por ruta (RBAC). Se validan parámetros de entrada usando express-validator. +
Total: control de roles y validación de entradas evitan modificaciones no autorizadas.
|Alta
...
|Information Disclosure
|Exposición de historiales clínicos
|Se restringe el acceso a rutas sensibles por roles. Se utiliza HTTPS para proteger la información en tránsito. +
Parcial: hay roles y HTTPS, pero no cifrado en almacenamiento.
|Alta
...
|Repudiation
|Negación de modificaciones
|Se registra cada evento relevante en una bitácora del sistema, permitiendo auditoría de operaciones sobre datos clínicos. +
Parcial: existe bitácora, pero sin firmas digitales ni sellado criptográfico.
|Media
...
|Tampering
|Manipulación de consultas médicas
|Se controla el acceso por rol a las rutas. Se validan los datos de entrada con express-validator antes de procesarlos. +
Total: roles y validación de datos cubren adecuadamente la amenaza.
|Alta
...
|Tampering
|Manipulación de citas
|Se limita el acceso a las operaciones de modificación mediante validación de roles y se registran eventos en bitácora. +
Parcial: control por roles y bitácora, sin integridad histórica.
|Media
...
|Elevation of Privilege
|Escalada de privilegios
|Se aplican validaciones de rol para permitir únicamente a administradores el acceso a rutas de gestión de empleados. +
Total: separación clara de roles administrativos.
|Alta
...
|Information Disclosure
|Exposición de datos en tránsito
|Se utiliza HTTPS con certificado autofirmado para cifrar las comunicaciones entre clientes y la API. +
Parcial: HTTPS con certificado autofirmado, no CA confiable.
|Alta
...
|Elevation of Privilege
|Ejecución de SQL no autorizado
|Se restringen las operaciones a través de la API y no se permite acceso directo a la base de datos desde clientes externos. +
Parcial: acceso solo vía API, sin cifrado en reposo ni auditoría avanzada.
|Alta
...
|Tampering
|Manipulación de datos en frontera de confianza
|Todos los parámetros de entrada se validan con express-validator antes de ser procesados por el sistema. +
Parcial: validación de parámetros, sin WAF ni sanitización profunda.
|Alta
|===


Una vez que se han identificado y documentado todo lo anterior, se procede a crear el modelo de amenazas con una herramienta especializada. En nuestro caso, recomendamos OWASP Threat Dragon, una herramienta de código abierto para modelado de amenazas que permite crear diagramas DFD y asociar amenazas y mitigaciones de manera visual.
